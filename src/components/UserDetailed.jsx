  ...
  return (
    ...
    <div className='p-5   gap-5 flex flex-wrap items-strech justify-center '>
        ...
        <div className={`shadow-lg rounded-lg p-6 w-full md:w-[40%] ${darkMode?'bg-white':'bg-gray-500'}`}>
            ...
            <p className={`${darkMode?'text-black':'text-gray-200'}`}><span className={`text-[18px] ml-8 `}>City</span>: {user.address.city}</p>
            <p className={`${darkMode?'text-black':'text-gray-200'}`}><span className={`text-[18px] ml-8 `}>Zipcode</span>: {user.address.zipcode}</p>
            <div className={`flex mt-2 gap-2 ${darkMode?'text-black':'text-gray-200'}`}>
